...
namespace Helpers {
	...
	ifstream& operator >> (ifstream& is, Address& a) {
		input_str(is,a.house_num, 113);
		input_str(is,a.sector, 117);
		input_str(is,a.city , 120);
		input_str(is,a.state, 107);
	//	input_line(is, { a.house_num,a.sector,a.city,a.state }, 100);
		return is;
	}
	ofstream& operator << (ofstream& os, Address& a) {
		output_str(os, a.house_num, 113);
		output_str(os, a.sector, 117);
		output_str(os, a.city, 120);
		output_str(os, a.state, 107);
